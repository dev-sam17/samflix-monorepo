...
export const validateProgressParams = (req: Request, res: Response, next: NextFunction): void => {
  try {
...
export const validateClerkIdParam = (req: Request, res: Response, next: NextFunction): void => {
  try {
...
export const validateSeriesParams = (req: Request, res: Response, next: NextFunction): void => {
  try {
